...
const DarkMode = () => {
    ...
    return (
        <div onClick={()=>setTheme(theme == 'dark' ? 'light' : 'dark')} className="relative h-8 w-8 min-w-[32px] cursor-pointer overflow-hidden rounded-full border-2 border-gray-100 bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
            {theme && (
                <>
                  <Moon
                    className={cn(
